...
def main():
    ...
    print("TEST B — HER horizon COURT (50 pas), config facile")
    ...
    print(f"Apprentissage {TOTAL_TIMESTEPS:,} pas, horizon 50. SURVEILLE success_rate :")
    print("  - s'il MONTE franchement -> l'horizon (300) était le coupable.")
    print("  - s'il reste bas -> on passera à la normalisation des observations.")
    print("  NB : épisodes courts -> success_rate plus réactif (plus d'épisodes/1000 pas).")
