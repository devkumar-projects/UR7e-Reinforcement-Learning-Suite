...
def main():
    ...
    print("TEST A — HER config FACILE (départ fixe + cibles avant, seuil 5 cm)")
    ...
    print(f"Apprentissage {TOTAL_TIMESTEPS:,} pas. SURVEILLE success_rate :")
    print("  - s'il MONTE -> HER sain, le 360°/départs sont le coupable.")
    print("  - s'il reste ~0 -> problème de fond à corriger.")
