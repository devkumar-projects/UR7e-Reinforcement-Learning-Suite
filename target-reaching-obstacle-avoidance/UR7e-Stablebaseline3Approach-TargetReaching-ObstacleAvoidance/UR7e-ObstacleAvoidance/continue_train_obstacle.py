# ==============================================================================
# FICHIER : continue_train_obstacle.py
# RÔLE : REPRENDRE l'entraînement reaching+évitement sans discontinuité
#        (recharge modèle + buffer, poursuit). Grâce au buffer rechargé,
#        pas de creux au redémarrage.
#
# Usage : caffeinate -i python continue_train_obstacle.py
# ==============================================================================
...
from train_sac_obstacle import (
    make_env, StatsCallback, LOG_DIR, MODEL_OUT, BUFFER_OUT, SEED,
)

ADDITIONAL_TIMESTEPS = 250_000      # pas supplémentaires (ajustable)
...
def main():
    ...
    print("1. Recréation de l'environnement obstacle...")
    env = make_env(SEED)
